        ...
        <section class="py-20 relative overflow-hidden">
            <div class="container mx-auto px-6 relative z-10">
                <div class="text-center">
                    ...
                    <p class="text-xl md:text-2xl mb-12 max-w-3xl mx-auto">Discover a world of magical literature where
                        every page turn is an adventure</p>
                    <a href="#"
                        class="bg-primary text-background px-8 py-4 rounded-full font-bold text-lg hover:bg-opacity-80 transition-all duration-300 inline-block">Begin
                        Your Magical Journey</a>
                </div>
            </div>
            <div class="absolute inset-0 z-0">
                <img src="https://i.pinimg.com/736x/c5/17/20/c5172086ae91a1c253b6e556b89d0176.jpg" alt="Magical Library"
        ...
        <section class="py-20 bg-secondary bg-opacity-30">
            <div class="container mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    <!-- Featured Book 1 -->
                    <div
                        class="bg-background rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:scale-105">
                        <img src="https://i.pinimg.com/736x/0a/44/c0/0a44c0696c44088bd7966aff4431a461.jpg"
                            alt="The Grand Grimoire" class="w-full h-64 object-cover">
                        <div class="p-6">
                            ...
                            <a href="#" class="text-accent hover:text-primary transition-colors duration-300">Explore
                                the tome →</a>
                        </div>
                    </div>
                    <!-- Featured Book 2 -->
                    <div
                        class="bg-background rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:scale-105">
                        <img src="https://i.pinimg.com/736x/4d/63/7d/4d637de115e622fa3564d811539a6e68.jpg"
                            alt="Potions for Beginners" class="w-full h-64 object-cover">
                        <div class="p-6">
                            ...
                            <a href="#" class="text-accent hover:text-primary transition-colors duration-300">Brew your
                                first potion →</a>
                        </div>
                    </div>
                    <!-- Featured Book 3 -->
                    <div
                        class="bg-background rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:scale-105">
                        <img src="https://i.pinimg.com/736x/d1/00/3a/d1003a5c9cf260cb86adb96022ee9d84.jpg"
                            alt="Fantastic Beasts Encyclopedia" class="w-full h-64 object-cover">
                        <div class="p-6">
                            <h3 class="text-xl font-heading font-bold mb-2 text-primary">Fantastic Beasts Encyclopedia
                            </h3>
                            <p class="text-sm mb-4">Discover the wondrous creatures of the magical world</p>
                            <a href="#" class="text-accent hover:text-primary transition-colors duration-300">Meet the
                                beasts →</a>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-20 relative overflow-hidden">
            <div class="container mx-auto px-6 relative z-10">
                <blockquote class="text-2xl md:text-4xl font-heading italic text-center max-w-4xl mx-auto">
                    <p class="mb-4">"Words are, in my not-so-humble opinion, our most inexhaustible source of magic."
                    </p>
            ...
            <div class="absolute inset-0 z-0 flex items-center justify-center opacity-10">
                <img src="https://i.pinimg.com/736x/fa/15/ed/fa15ed94d595a13bbe886a7ceb5731b8.jpg" alt="Magic Wand"
                    class="w-1/2 h-auto object-contain floating">
            </div>
        </section>
        ...
        <section class="py-20 bg-secondary bg-opacity-30">
            <div class="container mx-auto px-6">
                <div class="max-w-2xl mx-auto text-center">
                    ...
                    <p class="mb-8">Subscribe to receive enchanted book recommendations and exclusive magical content
                    </p>
                    <form class="flex flex-col sm:flex-row gap-4">
                        <input type="email" placeholder="Enter your email address"
                            class="flex-grow px-4 py-2 rounded-full bg-background border border-accent focus:outline-none focus:ring-2 focus:ring-primary">
                        <button type="submit"
                            class="bg-accent hover:bg-primary text-background px-6 py-2 rounded-full font-bold transition-colors duration-300">Subscribe</button>
                    </form>
                </div>
            </div>
        </section>
