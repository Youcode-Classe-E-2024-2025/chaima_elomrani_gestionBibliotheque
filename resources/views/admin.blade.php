...
<body class="bg-background text-text">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-6">
                    <button onclick="openAddModal()"
                        class="bg-primary text-background px-6 py-2 rounded-full font-bold hover:bg-opacity-80 transition-all duration-300 transform hover:scale-105">
                        Add New Book
                    </button>
                </div>
            </div>
        ...
        <div class="bg-secondary bg-opacity-50 rounded-xl p-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <input type="text" placeholder="Search books..."
                    class="magic-input px-4 py-2 rounded-full text-text focus:outline-none">
            </div>
                    ...
                    <tbody>
                        @foreach($books as $book)
                            <tr class="border-b border-primary border-opacity-20 hover:bg-accent hover:bg-opacity-10">
                                ...
                                <td class="py-4 px-4">
                                    <span
                                        class="px-3 py-1 rounded-full bg-success bg-opacity-20 text-success">{{ $book['status'] }}</span>
                                </td>
                                <td class="py-4 px-4">
            ...
            <div class="modal bg-secondary bg-opacity-95 rounded-xl shadow-2xl max-w-md w-full">
                <div class="p-6">
                    <div class="text-center">
                        <svg class="w-16 h-16 text-danger mx-auto mb-4" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex justify-center gap-4">
                            ...
                            <button
                                class="px-6 py-2 rounded-full bg-danger text-white hover:bg-opacity-80 transition-colors duration-300">
                                Delete Book
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        function showNotification(message, type = 'success') {
            ...
            notification.className = `fixed top-4 right-4 px-6 py-3 rounded-lg shadow-lg ${type === 'success' ? 'bg-success' : 'bg-danger'
