...
<body class="bg-background text-text">
    ...
    <div id="bookModal" class="hidden fixed inset-0 z-50">
        <div class="modal-backdrop absolute inset-0 flex items-center justify-center p-4">
            <div class="modal bg-secondary bg-opacity-95 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div class="md:w-2/3">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex flex-wrap gap-4 mt-8">
                                    <button class="bg-primary text-background font-bold py-3 px-6 rounded-full hover:bg-opacity-80 transition-all duration-300 transform hover:scale-105">
                                        Reserve Now
                                    </button>
                                    <button class="border-2 border-primary text-primary font-bold py-3 px-6 rounded-full hover:bg-primary hover:text-background transition-all duration-300 transform hover:scale-105">
                                        Add to Wishlist
                                    </button>
                                </div>
                            </div>
